                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex justify-between items-center h-20">
                        <div className="flex items-center space-x-2">
                            ...
                            <span className="font-bold text-2xl tracking-tight text-slate-900">Cloud<span className="text-brand-600">Hisaab</span></span>
                        </div>
            ...
            <section className="pb-20 px-4">
                <div className="max-w-6xl mx-auto">
                    ...
                    >
                        ...
                        <div className="p-6 md:p-10 grid grid-cols-1 lg:grid-cols-4 gap-6 bg-slate-50 h-[520px]">
                            {/* Sidebar */}
                            <div className="hidden lg:flex flex-col space-y-2 font-medium text-slate-500">
                                {['dashboard', 'billing', 'inventory', 'customers', 'reports'].map((tab) => {
                                    ...
                                    return (
                                        <button
                                            ...
                                            className={`flex items-center space-x-3 p-3 rounded-lg capitalize transition-all text-left outline-none ${activeTab === tab ? 'bg-brand-50 text-brand-700 shadow-sm' : 'hover:bg-slate-100 hover:text-slate-900'}`}
                                        >
                            ...
                            {/* Main Content */}
                            <div className="lg:col-span-3 space-y-6 relative overflow-hidden">
                                <motion.div
                                    key={activeTab}
                                ...
                                >
                                    {activeTab === 'dashboard' && (
                                        <div className="space-y-6">
                                            <div className="flex justify-between items-end">
                                                <div>
                                                    <h3 className="text-2xl font-bold tracking-tight">Today's Overview</h3>
                                                    <p className="text-slate-500 text-sm mt-1">October 24, 2024</p>
                                                </div>
                                                <button className="bg-brand-600 text-white px-4 py-2 rounded-lg text-sm font-semibold shadow-sm hidden sm:block">+ New Invoice</button>
                                            </div>
                                            {/* Stats Cards */}
                                    ...
                                    {activeTab === 'billing' && (
                                        <div className="space-y-6">
                                            <div className="flex justify-between items-center">
                                                ...
                                                <button className="bg-brand-600 text-white px-4 py-2 rounded-lg text-sm font-semibold shadow-sm">+ Create Invoice</button>
                                            </div>
                                    ...
                                    {activeTab === 'inventory' && (
                                        <div className="space-y-6">
                                            <div className="flex justify-between items-center">
                                                <h3 className="text-2xl font-bold tracking-tight">Stock List</h3>
                    ...
                    <div className="grid md:grid-cols-2 gap-10 mb-10 border-b border-slate-800 pb-10">
                        <div>
                            <div className="flex items-center space-x-2 text-white mb-6">
                                ...
                                <span className="font-bold text-2xl tracking-tight">CloudHisaab</span>
                            </div>
